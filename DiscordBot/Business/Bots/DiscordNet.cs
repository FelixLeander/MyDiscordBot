...
public sealed class DiscordNet(IServiceProvider serviceProvider, string botToken) : IHostedService
{
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        try
        {
            ...
            await _commands.AddModulesAsync(Assembly.GetExecutingAssembly(), serviceProvider);
